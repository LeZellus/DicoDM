 ...
 */
final class Version20221005143420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE word ADD exemple LONGTEXT NOT NULL, ADD is_pub TINYINT(1) NOT NULL, ADD is_online TINYINT(1) NOT NULL, ADD is_crush TINYINT(1) NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C3F17511989D9B62 ON word (slug)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_C3F17511989D9B62 ON word');
        $this->addSql('ALTER TABLE word DROP exemple, DROP is_pub, DROP is_online, DROP is_crush');
    }
}
